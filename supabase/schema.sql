...
alter table public.countries enable row level security;alter table public.locations enable row level security;alter table public.media enable row level security;alter table public.site_settings enable row level security;
...
('colombia','Colombia','phase1','CO',1,'Sep 2026','Colombia begins The 210 Project with colour, movement and arrival.','Medellin',array['First solo travel rhythm','Coffee region','Caribbean coast'],'sage',21,'upcoming'),
('peru','Peru','phase1','PE',2,'Sep / Oct 2026','Peru is the endurance chapter. Altitude, history and trekking turn the journey into a test of rhythm, patience and resilience.','Cusco',array['Machu Picchu sunrise','Cusco altitude lesson','Paracas coastline'],'copper',24,'live'),
('argentina','Argentina','phase1','AR',3,'Oct / Nov 2026','Argentina blends city energy with wilderness.','Buenos Aires',array['Buenos Aires evenings','Patagonia hikes','Ushuaia'],'terracotta',24,'upcoming'),
('brazil','Brazil','phase1','BR',4,'Nov / Dec 2026','Brazil closes the South America act.','Rio',array['Rio sunset','Island days','Iguacu Falls'],'ochre',24,'upcoming'),
('vietnam','Vietnam','phase2','VN',5,'Jan 2027','Vietnam opens the Asia act.','Hanoi',array['Street food','Lanterns','Coastline'],'brick',18,'upcoming'),
('south-korea','South Korea','phase2','KR',6,'Jan / Feb 2027','South Korea becomes a study in pace and structure.','Seoul',array['Seoul city rhythm','Markets','Busan coastline'],'plum',14,'upcoming'),
('japan','Japan','phase2','JP',7,'Feb 2027','Japan is the detail chapter.','Tokyo',array['Tokyo nights','Kyoto temples','Train journeys'],'rose',21,'upcoming'),
('hong-kong','Hong Kong','phase2','HK',8,'Mar 2027','Hong Kong compresses energy into skyline and movement.','Hong Kong Island',array['Skyline','Ferries','Viewpoints'],'wine',7,'upcoming'),
('singapore','Singapore','phase2','SG',9,'Mar 2027','Singapore closes the Asia act.','Marina Bay',array['Gardens','Hawker centres','Design'],'teal',7,'upcoming') on conflict (id) do nothing;
